...
$$ Q^\pi (s,a) = r_0 (s,a) +  \gamma Q^\pi(s', a') $$

Suppose we know how to compute the Q-value function. A very obvious policy is to select the action that maximizes  $$Q(s,a)$$, i.e. $$a = \pi(s) = \max_a Q(s, a)$$. 

$$ Q^\pi (s,a) = r_0 (s,a) +  \gamma \max_{a'} Q^\pi(s', a') $$
