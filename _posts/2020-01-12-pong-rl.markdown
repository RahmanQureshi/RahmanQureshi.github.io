...
This is the recursive form of the Q-value function. Note that the 0 subscript on the reward was dropped. he goal is to find a policy $$\pi^*$$ which maximizes the value of the Q-value function. The optimal Q-value function is:
