...
I added this section after feedback from some friends unfamiliar with RL who wanted to see how pacman could be cast using the formulation presented above. Aribitrarily, We will assume the game is played on a screen that is 200 pixels wide and 200 pixels long.
