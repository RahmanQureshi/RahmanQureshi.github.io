...
In part 1, my goal is to motivate the form of the loss function used in the paper (simplified):

$$L = (r +  \gamma \max_{a'} Q(s', a', \theta_{fixed}) - Q(s, a, \theta))^2 \;\;\;\; (1)$$


In doing so, I will attempt to explain what is the Q-value function, and what deep-Q learning is.

I assume background knowledge on machine learning and neural networks in general, and being familiar with the basics of reinforcement learning would be helpful, but I do give a brief overview.
